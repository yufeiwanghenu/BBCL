...
import test
import eval
from dataset_dota import DOTA
from dataset_hrsc import HRSC
...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=14, help='Number of epochs')
    parser.add_argument('--num_workers', type=int, default=0, help='Number of workers')
    parser.add_argument('--init_lr', type=float, default=1.09375e-4, help='Init learning rate')
    ...
    parser.add_argument('--resume', type=str, default='model_80.pth', help='weights to be resumed')
    parser.add_argument('--dataset', type=str, default='hrsc', help='weights to be resumed')
    parser.add_argument('--data_dir', type=str, default=r'E:\wyf\HRSC2016\FullDataSet', help='data directory')
    # parser.add_argument('--data_dir', type=str, default=r'E:\wyf\DOTAdata\trainval', help='data directory')
    parser.add_argument('--phase', type=str, default='eval', help='data directory')
